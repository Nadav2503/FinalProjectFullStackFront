...
import EditExhibitPage from "../Exhibit/pages/EditExhibitPage";
...
export default function Router() {
    return (
        <Routes>
            ...
            < Route path={ROUTES.ADDEXHIBITS} element={< AddExhibitPage />} />
            < Route path={ROUTES.EDITEXHIBITS} element={< EditExhibitPage />} />
